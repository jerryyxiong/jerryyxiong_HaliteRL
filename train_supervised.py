...
def create_unet():
    ...
    d6 = layers.BatchNormalization()(d6)
    d6 = layers.Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu', kernel_initializer='he_normal')(d6)
    d6 = layers.BatchNormalization()(d6)
    ...
    d5 = layers.Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu', kernel_initializer='he_normal')(d5)
    d5 = layers.BatchNormalization()(d5)
    ...
    d3 = layers.Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu', kernel_initializer='he_normal')(d3)
    d3 = layers.BatchNormalization()(d3)
    d3 = layers.Conv2D(64, kernel_size=3, padding='same', kernel_initializer='he_normal')(d3)

    d2 = layers.Activation('relu')(d3)
    d2 = layers.BatchNormalization()(d2)
    d2 = layers.Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu', kernel_initializer='he_normal')(d2)
    d2 = layers.BatchNormalization()(d2)
    d2 = layers.Conv2D(64, kernel_size=3, padding='same', kernel_initializer='he_normal')(d2)

    d1 = layers.Activation('relu')(d2)
    d1 = layers.BatchNormalization()(d1)
    d1 = layers.Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu', kernel_initializer='he_normal')(d1)
    d1 = layers.BatchNormalization()(d1)
    ...
    lf = layers.Conv2D(64, kernel_size=3, strides=2, padding='same', activation='relu', kernel_initializer='he_normal')(lf)
    lf = layers.BatchNormalization()(lf)
...
class Dataset(tf.keras.utils.Sequence):
    ...
    def __getitem__(self, idx):
        ...
        return [
            np.array([data['frames'] for data in loaded]),
            np.array([data['meta'] for data in loaded])
        ], np.array([data['moves'] for data in loaded])
...
model = create_unet()
model.fit(train_dataset, epochs=10, callbacks=[cp_callback], validation_data=val_dataset)
